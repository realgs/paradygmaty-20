...
class HeapSortTest {
	...
	void Simpletest() {
		...
		sortedlist1.add(47);
		sortedlist1.add(50);
		assertEquals(sortedlist1, hs.sort(list));
	}
	...
	void reverseSorted() {
		...
		assertEquals(slist, hs.sort(rslist));
	}

	@Test
	void arrayHSSortTest() {
		...
		assertEquals(sortedlist, hs.sort(array));
	}
}
