...
class ImmutableBoard(private[this] val board: Array[Array[Int]])
{
  ...
  def gatherPlayersStones(player_id: Int): ImmutableBoard =
  {
    val board: Array[Array[Int]] = cloneBoard()
  ...
  private def cloneBoard(): Array[Array[Int]] =
    {
