...
object Game extends App {
  ...
  Helper.getInputFromUser() match {
    case 1 => playerOne = actorSystem.actorOf(Props(classOf[Client], Player.NPC_PLAYER_ONE))
  ...
  println("Choice: ")
  Helper.getInputFromUser() match {
    case 1 => playerTwo = actorSystem.actorOf(Props(classOf[Client], Player.NPC_PLAYER_TWO))
