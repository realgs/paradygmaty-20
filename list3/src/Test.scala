object Test {
  ...
  def zad5Test(): Unit = {
    ...
    println("1." + (L3.joinListsTail(List(1, 2, 3), List(4, 5, 6), List(7, 8, 9)) == List(1, 2, 3, 4, 5, 6, 7, 8, 9)).toString)
    println("2." + (L3.joinListsTail(List(), List(4, 5, 6), List(7, 8, 9)) == List(4, 5, 6, 7, 8, 9)).toString)
    println("3." + (L3.joinListsTail(List(1, 2, 3), List(), List(7, 8, 9)) == List(1, 2, 3, 7, 8, 9)).toString)
    println("4." + (L3.joinListsTail(List(1, 2, 3), List(4, 5, 6), List()) == List(1, 2, 3, 4, 5, 6)).toString)
    println("5." + (L3.joinListsTail(List(1, 2, 3), List(), List()) == List(1, 2, 3)).toString)
    println("6." + (L3.joinListsTail(List(), List(4, 5, 6), List()) == List(4, 5, 6)).toString)
    println("7." + (L3.joinListsTail(List(), List(), List(7, 8, 9)) == List(7, 8, 9)).toString)
    println("8." + (L3.joinListsTail(List(), List(), List()) == List()).toString)
    println("9." + (L3.joinListsTail(List("a"), List("b"), List("c")) == List("a", "b", "c")).toString)
    println("Combining without tailrec")
    println("1." + (L3.joinLists(List(1, 2, 3), List(4, 5, 6), List(7, 8, 9)) == List(1, 2, 3, 4, 5, 6, 7, 8, 9)).toString)
    println("2." + (L3.joinLists(List(), List(4, 5, 6), List(7, 8, 9)) == List(4, 5, 6, 7, 8, 9)).toString)
    println("3." + (L3.joinLists(List(1, 2, 3), List(), List(7, 8, 9)) == List(1, 2, 3, 7, 8, 9)).toString)
    println("4." + (L3.joinLists(List(1, 2, 3), List(4, 5, 6), List()) == List(1, 2, 3, 4, 5, 6)).toString)
    println("5." + (L3.joinLists(List(1, 2, 3), List(), List()) == List(1, 2, 3)).toString)
    println("6." + (L3.joinLists(List(), List(4, 5, 6), List()) == List(4, 5, 6)).toString)
    println("7." + (L3.joinLists(List(), List(), List(7, 8, 9)) == List(7, 8, 9)).toString)
    println("8." + (L3.joinLists(List(), List(), List()) == List()).toString)
    println("9." + (L3.joinLists(List("a"), List("b"), List("c")) == List("a", "b", "c")).toString)
  }
}
