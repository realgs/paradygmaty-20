...
class ExerciseOneAndTwoTests extends AnyFlatSpec {
  "duplicate function" should "work properly if second queue size is greater or equal than first queue size" in {
  ...
  "duplicate function" should "throw an IllegalArgumentException if second queue size is less than first queue size" in {
  ...
  "duplicate function" should "throw an IllegalArgumentException if second queue contains at least one element with negative value in n first elements where n is size of the first queue" in {
  ...
  "duplicateWithoutDuplicates function" should "work properly if queue size is greater or equal than set size" in {
  ...
  "duplicateWithoutDuplicates function" should "throw an IllegalArgumentException if second queue size is less than first queue size" in {
  ...
  "duplicateWithoutDuplicates function" should "throw an IllegalArgumentException if second queue contains at least one element with negative value in n first elements where n is size of the first queue" in {
